<!-- ============================================================
     OUR WORK — Projects & Programmes grouped by focus area
     ============================================================ -->
<section id="our-work">
    <div class="section-wrapper">
        <p class="eyebrow">Our Work</p>
        <h1 class="section-title">Projects &amp; Programmes</h1>
        <p class="section-sub">18 active initiatives across Bangladesh — ICT-powered agriculture, nutrition, women's empowerment, and SME development, organized by focus area. Each still carries its original Project or Programme designation.</p>

        <!-- Pillar: Nutrition -->
        <div class="work-pillar" id="pillar-nutrition">
            <div class="work-pillar-header"><i class="ti ti-apple"></i><h3>Nutrition</h3></div>
            <div class="card-grid">
        ...
        <!-- Pillar: Agriculture & ICT -->
        <div class="work-pillar" id="pillar-agriculture">
            <div class="work-pillar-header"><i class="ti ti-plant"></i><h3>Agriculture &amp; ICT</h3></div>
            <div class="card-grid">
        ...
        <!-- Pillar: Women's Digital Empowerment -->
        <div class="work-pillar" id="pillar-women">
            <div class="work-pillar-header"><i class="ti ti-device-mobile"></i><h3>Women's Digital Empowerment</h3></div>
            <div class="card-grid">
        ...
        <!-- Pillar: SME & Digital Literacy -->
        <div class="work-pillar" id="pillar-sme">
            <div class="work-pillar-header"><i class="ti ti-briefcase"></i><h3>SME &amp; Digital Literacy</h3></div>
            <div class="card-grid">
