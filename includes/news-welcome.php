...
<section id="about">
    ...
    <!-- Two Column: News + Welcome -->
    <div class="two-col-section">

        <!-- Recent News -->
        <div class="recent-news-col">
            <h3 id="recent-news-section">&#128240; More Recent News</h3>
            <div class="news-scroll">
                ...
                <div class="news-card-item">
                    ...
                    <p>International Nutrition Olympiad (INO) 2026 was officially launched on 9 July 2026 at Amari Dhaka, Gulshan. Organised by BIID Foundation in collaboration with GAIN Bangladesh, the initiative brings together government, the private sector, academia, development partners, youth organisations, and civil society. The INO 2026 Grand Finale is scheduled for 10–11 December 2026 in Bangladesh.</p>
                </div>
                ...
                <div class="view-all-news">
                    <a href="#" onclick="alert('News archive coming soon!'); return false;">&#128196; View All News &amp; Updates</a>
                </div>
        ...
        <div class="welcome-col">
            ...
            <div class="welcome-logo-wrap">
                <img src="img/BIID.png" alt="BIID Logo">
                <p>BIID Foundation is an inclusive business initiative engaged in developing ICT enabled products and services to support private and public (Government and NGO) initiatives targeted for the BoP (Base of the Pyramid) segment in particular and citizens in general in providing them with access to ICTs and ICT enabled information and services.</p>
            </div>
